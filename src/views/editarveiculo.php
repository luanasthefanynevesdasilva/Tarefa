    ...
    <div class="container">
        ...
        <form class='form' action="./editarveiculo.php?id=<?= $veiculo->getidveiculo() ?>" method="POST">
            ...
            <div class="mb-3"><br>
                ...
                <input type="text" step="any" minlength="4" maxlength="4"  value="<?= $veiculo->getano() ?>" name="ano" class="form-control" id="ano" autocomplete="off" required>
            </div>
            <div class="mb-3"><br>
                <label for="cor" class="form-label">cor</label>
                <input type="text" step="any"    value="<?= $veiculo->getcor() ?>" name="cor" class="form-control" id="cor" autocomplete="off" required>
            </div>
            <div class="mb-3"><br>
                <label for="placa" class="form-label">placa</label>
                <input type="text" step="any"   value="<?= $veiculo->getplaca() ?>" name="placa" class="form-control" id="placa" autocomplete="off" required>
            </div>
            <div class="mb-3"><br>
                <label for="status" class="form-label">status</label>
                <input type="text" step="any"  value="<?= $veiculo->getstatus() ?>" name="status" class="form-control" id="status" autocomplete="off" required>
            </div>
            <div class="mb-3"><br>
