    ...
    <div class="container">
        ...
        <form class='form' action="./editarCliente.php?id=<?= $cliente->getidcliente() ?>" method="POST">
            <div class="mb-3">
                ...
                <input type="text"  value="<?= $cliente->getNome() ?>" name="nome" class="form-control" id="nome" autocomplete="off" required>
            </div>
            ...
            <div class="mb-3 d-flex justify-content-between">
                <div class="input">
                    ...
                    <input type="tel"  name="telefone"  minlength="10" maxlength="10" value="<?= $cliente->gettelefone() ?>" step="any" name="telefone" class="form-control" id="telefone" required>
                </div>
            </div>
            <div class="button"><br>
