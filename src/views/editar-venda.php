    ...
    <div class="container">
        ...
        <form class='form' id="form" action="./editar-venda.php?id=<?= $idaluguel ?>" method="POST">
            <div class="mb-3">  
                ...
                <input type="number" step="any"  value="<?= $aluguel->getdiaria() ?>" name="diaria" class="form-control" id="diaria" autocomplete="off" required>
            </div>
                                  <div class="mb-3">
                <label for="combustivelatual" class="form-label">combustivel-atual</label>
                <input type="number" step="any"  value="<?= $aluguel->getcombustivelatual() ?>" name="combustivelatual" class="form-control" id="combustivelatual" autocomplete="off" required>
            </div>
                                  <div class="mb-3">
