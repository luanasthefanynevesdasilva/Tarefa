...
if($combustiveldevolucao && $total && $extra && $idaluguel ){
...
$sql= Database::prepare("INSERT INTO devolucao (combustiveldevolucao,total,extra,idaluguel) VALUES (:combustiveldevolucao, :total, :extra, :idaluguel)");
